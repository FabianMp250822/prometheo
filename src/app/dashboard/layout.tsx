        ...
        <SidebarContent>
          <SidebarMenu>
            <SidebarMenuItem>
             ...
             <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip="Consulta IA">
                <Link href="/dashboard/consulta-ai">
                  <BrainCircuit />
                  <span className="group-data-[collapsible=icon]:hidden">Consulta IA</span>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
            <SidebarMenuItem>
