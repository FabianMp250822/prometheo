            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-2xl font-headline flex items-center gap-2">
                        ...
                        Liquidador: Precedente Escolástica CSD 39783 (2013)
                    </CardTitle>
                    <CardDescription>
                        Realice cálculos basados en el precedente de la sentencia CSD 39783 del año 2013.
                    </CardDescription>
                </CardHeader>
            </Card>
                    ...
                    <CardContent>
                        <Tabs defaultValue="anexo2" className="w-full">
                            ...
                            <TabsContent value="preliquidación" className="mt-4">
                                <p className="text-muted-foreground">Contenido para la preliquidación de Precedente Escolástica.</p>
                            </TabsContent>
