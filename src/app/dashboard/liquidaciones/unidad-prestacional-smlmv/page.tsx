            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-2xl font-headline flex items-center gap-2">
                        ...
                        Liquidador: Unidad Prestacional 4-71 (SMLMV)
                    </CardTitle>
                    <CardDescription>
                        Ejecuta liquidaciones de unidad prestacional según la Ley 4 y el Salario Mínimo Legal Mensual Vigente.
                    </CardDescription>
                </CardHeader>
            </Card>
                    ...
                    <CardContent>
                        <Tabs defaultValue="anexo2" className="w-full">
                            ...
                            <TabsContent value="preliquidación" className="mt-4">
                                <p className="text-muted-foreground">Contenido para la preliquidación de Unidad Prestacional SMLMV.</p>
                            </TabsContent>
