...
import { UserPlus, Loader2, PlusCircle, Trash2, FileUp } from 'lucide-react';
    ...
    <div className="p-4 md:p-8 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Complete el formulario para registrar un nuevo cliente en el sistema.</CardDescription>
        </CardHeader>
      </Card>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Card>
          <CardHeader><CardTitle className="text-xl">Información de Contrato y Pagos</CardTitle></CardHeader>
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="grupo">Grupo</Label>
                <Select name="grupo" value={formData.grupo} onValueChange={handleGrupoChange} required>
                  <SelectTrigger>{isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : <SelectValue placeholder="Seleccione un grupo" />}</SelectTrigger>
                  <SelectContent>
        ...
        <Card>
            <CardHeader><CardTitle className="text-xl">Carga de Documentos</CardTitle></CardHeader>
            <CardContent className="space-y-4">
